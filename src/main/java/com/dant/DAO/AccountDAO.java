...
public class AccountDAO extends BasicDAO<Account, String> {
    ...
    public static void dataInit(){
        ...
        Account test = new Account("K","2000","1234567890","k200@gmail.com","test",new Position(123.12,456.98),"toto1");
        Account test1 = new Account("KK","2001","1234567890","k200@gmail.com","test",new Position(123.12,456.98),"toto12");
        Account test2 = new Account("KK","2002","1234567890","k200@gmail.com","test",new Position(123.12,456.98),"toto12345");
        datastore.save(test);
